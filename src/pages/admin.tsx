...
export const isEditMode = () =>
  localStorage.getItem(getKey('edit-mode')) === 'true'
  ...
  return (
    <div sx={{}}>
      ...
      >
        ...
        <span sx={{ mb: 2 }}>
          <Label htmlFor="github-token" sx={{ fontWeight: 'bold' }}>
            Github token
          </Label>
          <span sx={{ display: 'flex' }}>
            <Input
              ...
              type={displayGithubToken ? 'text' : 'password'}
              onChange={(e) => {
            ...
            >
              <Checkbox
                checked={displayGithubToken}
                onChange={() => setDisplayGithubToken(!displayGithubToken)}
                sx={{ mr: 0, ml: 1 }}
              />
              Show
            </Label>
