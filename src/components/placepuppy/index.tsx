...
const puppyImages = [puppy1, puppy2, puppy3, puppy4, puppy5, puppy6, puppy7, puppy8, puppy9, puppy10, puppy11, puppy12, puppy13, puppy14, puppy15, puppy16, puppy17, puppy18, puppy19, puppy20, puppy21, puppy22, puppy23, puppy24, puppy25, puppy26, puppy27, puppy28];

const getPuppyByIndex = (index: number) => {
  return puppyImages[index % puppyImages.length];
}

const PlacePuppy: FC<PlacePuppyProps> = ({ width = 200, height = 150, className = '', alt = 'A cute puppy', index = 0 }) => {
