...
export async function parseGdoc(doc: docs_v1.Schema$Document, recipeDir: string, auth: any, googleDocQueue: PQueue): Promise<GdocParseResult> {
  let markdown = '';
  let imageCounter = 0;
...
export function parseYamlMetadata(description: string | undefined): RecipeMetadata | undefined {
