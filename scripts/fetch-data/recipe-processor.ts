...
export async function processDoc(file: drive_v3.Schema$File, auth: any, queues: Queues) {
  ...
  try {
    ...
    const cachedDoc: docs_v1.Schema$Document & { modifiedTime: string } = JSON.parse(cachedData);
